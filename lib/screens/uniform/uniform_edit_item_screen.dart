...
import 'package:school_management_system/components/uniform_center/uniform_items/edit_item.dart';
...
class UniformEditItemScreen extends StatelessWidget {
  UniformItemModel item;
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  UniformEditItemScreen(this.item);
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: EditUniformItem(_scaffoldKey,item),
            ),
          ],
        ),
      ),
