...
import 'package:school_management_system/components/uniform_center/low_stock/uniform_low_stock_item.dart';
import 'package:school_management_system/components/uniform_center/uniform_attributes/uniform_attribute.dart';
import 'package:school_management_system/components/uniform_center/uniform_delivery/uniform_add_delivery_items.dart';
import 'package:school_management_system/components/uniform_center/uniform_items/add_item.dart';
...
class UniformLowStockScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: UniformLowStockItem(_scaffoldKey),
            ),
          ],
        ),
      ),
