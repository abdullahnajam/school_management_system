...
import 'package:school_management_system/components/financial/activity_fees/activity_fees.dart';
import 'package:school_management_system/components/financial/uniform_fee/uniform_fees.dart';
...
class UniformFeeScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: UniformFees(_scaffoldKey),
            ),
          ],
        ),
      ),
