...
import 'package:school_management_system/components/busses/bus_coordinator/bus_coordinator.dart';
...
class BusCoordinatorScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: BusCoordinator(_scaffoldKey),
            ),
          ],
        ),
      ),
