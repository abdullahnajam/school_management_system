...
import 'package:school_management_system/components/reports/income/revenue_detail/class/class_revenue.dart';
...
import 'package:school_management_system/components/reports/income/revenue_detail/student/student_revenue.dart';
...
class StudentReportScreen extends StatelessWidget {
  ...
  StudentReportScreen(this.type,this.classId);
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: StudentRevenue(_scaffoldKey,type,classId),
            ),
          ],
        ),
      ),
