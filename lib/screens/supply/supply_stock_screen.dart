...
import 'package:school_management_system/components/school_supplies/supply_stock/supply_stock.dart';
import 'package:school_management_system/components/uniform_center/uniform_stock/uniform_stock.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: SupplyStock(_scaffoldKey),
            ),
          ],
        ),
      ),
