...
import 'package:school_management_system/components/school_supplies/supply_delivery/supply_delivery.dart';
import 'package:school_management_system/components/uniform_center/uniform_delivery/uniform_delivery.dart';
...
class SupplyDeliveryScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: SupplyDelivery(_scaffoldKey),
            ),
          ],
        ),
      ),
