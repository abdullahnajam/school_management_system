...
import 'package:school_management_system/components/school_supplies/supply_supplier/supply_supplier.dart';
import 'package:school_management_system/components/uniform_center/uniform_supplier/uniform_supplier.dart';
...
class SupplySupplierScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: SupplySupplier(_scaffoldKey),
            ),
          ],
        ),
      ),
