...
import 'package:school_management_system/components/school_supplies/supply_variation/supply_variation.dart';
...
class SupplyVariationScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: SupplyVariation(_scaffoldKey),
            ),
          ],
        ),
      ),
