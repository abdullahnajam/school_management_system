...
import 'package:school_management_system/components/book_center/delivery/delivery.dart';
...
class BookDeliveryScreen extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: BookDelivery(_scaffoldKey),
            ),
          ],
        ),
      ),
