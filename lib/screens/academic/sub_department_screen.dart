...
import 'package:school_management_system/components/academic/departments/sub_departments_list.dart';
...
class SubDepartmentScreen extends StatelessWidget {
  ...
  SubDepartmentScreen(this.departmentIds);
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              flex: 5,
              child: DepartmentDetailList(_scaffoldKey,departmentIds),
            ),
          ],
        ),
      ),
