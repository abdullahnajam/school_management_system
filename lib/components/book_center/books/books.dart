                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text("Add Book",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                            ),
                          ),
                          Align(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                color: Colors.black,
                                alignment: Alignment.center,
                                child: Text("Add Book",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                              ),
                            )
                          ],
                        ),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Books",widget._scaffoldKey),
