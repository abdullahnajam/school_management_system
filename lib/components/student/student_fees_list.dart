...
class StudentFeeList extends StatefulWidget {
  String studentId;

  StudentFeeList(this.studentId);

  @override
  _StudentFeeListState createState() => _StudentFeeListState();
}


class _StudentFeeListState extends State<StudentFeeList> {
  ...
  DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
    ...
    return DataRow(
        cells: [
          ...
          DataCell(Text(model.feeCategory.toString())),
