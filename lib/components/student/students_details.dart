...
class StudentDetails extends StatefulWidget {
  ...
  StudentDetails(this._scaffoldKey,this.studentModel);
            ...
            Row(
              ...
              children: [
                ...
                if (!Responsive.isMobile(context))
                  Expanded(
                    flex: 2,
                    child: StudentDetailSidebar(widget.studentModel),
                  ),
                if (!Responsive.isMobile(context))
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (Responsive.isMobile(context)) StudentDetailSidebar(widget.studentModel),
                      SizedBox(height: defaultPadding),
                      StudentDetailTab(widget.studentModel),
                      if (Responsive.isMobile(context))
                        SizedBox(height: defaultPadding),
