...
class EditUniformItem extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;
  UniformItemModel item;

  EditUniformItem(this._scaffoldKey,this.item);

  @override
  _EditUniformItemState createState() => _EditUniformItemState();
}

class _EditUniformItemState extends State<EditUniformItem> {
  ...
  void initState() {
    ...
    widget.item.gallery.forEach((element) {
      galleryImagesUrl.add(element);
      galleryImageUploading.add(false);
    });
    ...
    _lowStockWarningController.text=widget.item.lowStockQuantity;
    _stockController.text=widget.item.stock.toString();
    _skuController.text=widget.item.sku.toString();
                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      FirebaseFirestore.instance.collection('uniform_items').doc(widget.item.id).update({
                        'name': item.name,
                    ...
                    child: Container(
                      ...
                      color: primaryColor,
                      alignment: Alignment.center,
                      child: Text("Update Uniform Item",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                    ),
                  )
