...
class UniformSupplierList extends StatefulWidget {
  const UniformSupplierList({Key? key}) : super(key: key);

  @override
  _UniformSupplierListState createState() => _UniformSupplierListState();
}


class _UniformSupplierListState extends State<UniformSupplierList> {
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('uniform_suppliers').doc(model.id).update({
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('uniform_suppliers').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => UniformSupplierScreen())));
                  },
                )..show();
              },
