...
import 'grade_revenue_list.dart';


class GradeRevenue extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;
  String type,departmentId;

  GradeRevenue(this._scaffoldKey,this.type,this.departmentId);

  @override
  _GradeRevenueState createState() => _GradeRevenueState();
}

class _GradeRevenueState extends State<GradeRevenue> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Grade Report",widget._scaffoldKey),
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: defaultPadding),
                      GradeRevenueList(widget.type,widget.departmentId),
