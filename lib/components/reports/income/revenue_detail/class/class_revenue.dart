...
import 'class_revenue_list.dart';


class ClassRevenue extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;
  String type,gradeId;

  ClassRevenue(this._scaffoldKey,this.type,this.gradeId);

  @override
  _ClassRevenueState createState() => _ClassRevenueState();
}

class _ClassRevenueState extends State<ClassRevenue> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Class Report",widget._scaffoldKey),
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: defaultPadding),
                      ClassRevenueList(widget.type,widget.gradeId),
