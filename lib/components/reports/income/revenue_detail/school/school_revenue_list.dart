...
import 'package:school_management_system/screens/reports/income/department_report_screen.dart';
import 'package:school_management_system/screens/reports/income/school_report_screen.dart';
import 'package:school_management_system/utils/constants.dart';
import 'package:sn_progress_dialog/progress_dialog.dart';
import 'package:firebase/firebase.dart' as fb;
class SchoolRevenueList extends StatefulWidget {
  String type;


  SchoolRevenueList(this.type);

  @override
  _SchoolRevenueListState createState() => _SchoolRevenueListState();
}


class _SchoolRevenueListState extends State<SchoolRevenueList> {
  ...
  Future<int> getTotalRevenue(String valueType,String id)async{
    int total=0;
    await FirebaseFirestore.instance.collection('fees').where("schoolId",isEqualTo: id).where("feeCategory",isEqualTo:widget.type).get().then((QuerySnapshot querySnapshot) {
    ...
    return DataRow(
        cells: [
          ...
          DataCell(
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => DepartmentReportScreen(widget.type, model.id)));
