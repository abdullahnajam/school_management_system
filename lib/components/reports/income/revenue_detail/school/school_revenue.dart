...
class SchoolRevenue extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;
  String type;

  SchoolRevenue(this._scaffoldKey,this.type);

  @override
  _SchoolRevenueState createState() => _SchoolRevenueState();
}

class _SchoolRevenueState extends State<SchoolRevenue> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("School Report",widget._scaffoldKey),
