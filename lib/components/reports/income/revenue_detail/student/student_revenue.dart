...
import 'student_revenue_list.dart';


class StudentRevenue extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;
  String type,classId;

  StudentRevenue(this._scaffoldKey,this.type,this.classId);

  @override
  _StudentRevenueState createState() => _StudentRevenueState();
}

class _StudentRevenueState extends State<StudentRevenue> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Student Report",widget._scaffoldKey),
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: defaultPadding),
                      StudentRevenueList(widget.type,widget.classId),
