...
import 'employee_category_sidebar.dart';
...
class _EmployeesState extends State<Employees> {
  ...
  add(String schoolId,departmentId,categoryId,photo) async{
    print("rr");
    final ProgressDialog pr = ProgressDialog(context: context);
    pr.show(max: 100, msg: "Adding");
    FirebaseFirestore.instance.collection('employees').add({
      // String id,name,school,department,schoolId,departmentId,category,categoryId,status,photo,nationalId;
      'name': nameController.text,
      'school': schoolController.text,
      'department': departmentController.text,
      'category': _categoryController.text,
      'photo': photo,
      'uniqueId': "e${schoolController.text[0]}${departmentController.text[0]}${codes!.employee}",
  ...
  Future<void> _showAddDialog() async {
    ...
    String schoolId="",departmentId="",_categoryId="";
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text("Add Employees",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                            ),
                          ),
                          Align(
                      ...
                      InkWell(
                        onTap: (){
                          print("tap");
                          add(schoolId,departmentId,_categoryId,imageUrl);
                        },
                        child: Container(
                          height: 50,
                          color: Colors.black,
                          alignment: Alignment.center,
                          child: Text("Add Employee",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                        ),
                      )
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Employee",widget._scaffoldKey),
                  ...
                  child: Column(
                    children: [
                      ...
                      if (Responsive.isMobile(context))
                        SizedBox(height: defaultPadding),
                      if (Responsive.isMobile(context)) EmployeeCategorySidebar(),
                    ],
                  ),
                ),
                if (!Responsive.isMobile(context))
