...
class EmployeeCategorySidebar extends StatefulWidget {
  const EmployeeCategorySidebar({Key? key}) : super(key: key);

  @override
  _EmployeeCategorySidebarState createState() => _EmployeeCategorySidebarState();
}

class _EmployeeCategorySidebarState extends State<EmployeeCategorySidebar> {
  ...
  add() async{
    ...
    FirebaseFirestore.instance.collection('employee_categories').add({
      /*String id,name,mainCategoryName,mainCategoryId;
  bool isSubCategory,isArchived;
  int datePosted;*/
      'name': _nameController.text,
      'mainCategoryName': "none",
      'mainCategoryId': "none",
      'isSubCategory': false,
      'isArchived': false,
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: (){
                                      AwesomeDialog(
                                        ...
                                        btnOkOnPress: () {
                                          FirebaseFirestore.instance.collection('employee_categories').doc(document.reference.id).delete().then((value) =>
                                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => EmployeeScreen())));
                                        },
                                      )..show();
                                    },
