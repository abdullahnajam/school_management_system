...
import 'package:school_management_system/model/staff_model.dart';
                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text("Edit",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                          ),
                        ),
                        Align(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('staff').doc(model.id).update({
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = StaffModel.fromSnapshot(data);
  return DataRow(
      cells: [
        ...
        DataCell(Text(model.place.toString())),
        DataCell(Row(
          children: [
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('staff').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => StaffScreen())));
                  },
                )..show();
              },
