...
import 'package:school_management_system/model/discount_model.dart';
...
Future<void> _showEdit(BuildContext context,DiscountModel model) async {
                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text("Edit Discount",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                          ),
                        ),
                        Align(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('discounts').doc(model.id).update({
                            ...
                            child: Container(
                              ...
                              color: Colors.black,
                              alignment: Alignment.center,
                              child: Text("Update Discount",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                            ),
                          )
                        ],
                      ),
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = DiscountModel.fromSnapshot(data);
  return DataRow(
      cells: [
    DataCell(Text(model.name)),
        DataCell(Text(model.category)),
        DataCell(model.type=='Percentage'?Text("${model.value}%"):Text("\$${model.value}")),
        DataCell(Row(
          children: [
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('discounts').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => DiscountScreen())));
                  },
                )..show();
              },
