...
class DiscountCategorySidebar extends StatefulWidget {
  const DiscountCategorySidebar({Key? key}) : super(key: key);

  @override
  _DiscountCategorySidebarState createState() => _DiscountCategorySidebarState();
}

class _DiscountCategorySidebarState extends State<DiscountCategorySidebar> {
  ...
  add(String id) async{
    ...
    FirebaseFirestore.instance.collection('discount_categories').add({
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: (){
                                      AwesomeDialog(
                                        ...
                                        btnOkOnPress: () {
                                          FirebaseFirestore.instance.collection('discount_categories').doc(document.reference.id).delete().then((value) =>
                                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => DiscountScreen())));
                                        },
                                      )..show();
                                    },
