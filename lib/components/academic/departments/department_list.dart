...
var mainDepartmentNameController=TextEditingController();

Future<void> _showEditDepartment(BuildContext context,DepartmentModel model) async {
  String schoolId=model.schoolId;
  bool isSub=model.isSubDepartment;
  String _mainDepartmentId=model.mainDepartmentId;
    ...
    builder: (BuildContext context) {
      return StatefulBuilder(
        builder: (context, setState) {
          ...
          departmentController.text=model.name;
          mainDepartmentNameController.text=model.mainDepartmentName;
          schoolNameController.text=model.schoolName;
                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text("Edit Department",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                          ),
                        ),
                        Align(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                              ...
                                              child: Container(
                                                ...
                                                child: StreamBuilder<QuerySnapshot>(
                                                  stream: FirebaseFirestore.instance.collection('departments')
                                                      .where("isSubDepartment",isEqualTo: false).snapshots(),
                                                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                                    if (snapshot.hasError) {
                                                      return Center(
                                                        child: Column(
                                                      ...
                                                      children: snapshot.data!.docs.map((DocumentSnapshot document) {
                                                        ...
                                                        return new Padding(
                                                          ...
                                                          child: ListTile(
                                                            onTap: (){
                                                              setState(() {
                                                                mainDepartmentNameController.text="${data['name']}";
                                                                _mainDepartmentId=document.reference.id;
                                                              });
                                                              Navigator.pop(context);
                                                            },
                                                            title: Text("${data['name']}",style: TextStyle(color: Colors.black),),
                                ...
                                controller: mainDepartmentNameController,
                                style: TextStyle(color: Colors.black),
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Please enter some text';
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('departments').doc(model.id).update({
                                'name': departmentController.text,
                                'schoolName': schoolNameController.text,
                                'schoolId': schoolId,
                                'mainDepartmentName': isSub?mainDepartmentNameController.text:"none",
                                'mainDepartmentId': _mainDepartmentId,
                            ...
                            child: Container(
                              ...
                              color: Colors.black,
                              alignment: Alignment.center,
                              child: Text("Update Department",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                            ),
                          )
                        ],
                      ),
        ...
        DataCell(Row(
          children: [
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('departments').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => DepartmentScreen())));
                  },
                )..show();
              },
            ...
            IconButton(
              ...
              color: primaryColor,
              onPressed: (){
                _showEditDepartment(context,model);
              },
            ),
          ],
        )),
