                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('classes').doc(model.id).update({
                            ...
                            child: Container(
                              ...
                              color: Colors.black,
                              alignment: Alignment.center,
                              child: Text("Update Class",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                            ),
                          )
                        ],
                      ),
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  ...
  return DataRow(
    ...
    DataCell(Text(model.school)),
        ...
        DataCell(Text(model.maxCapacity.toString())),
        DataCell(Text(model.minCapacity.toString())),
        DataCell(Row(
          children: [
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('classes').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => ClassScreen())));
                  },
                )..show();
              },
