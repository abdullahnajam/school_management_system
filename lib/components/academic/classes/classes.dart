...
class SchoolClasses extends StatefulWidget {
  ...
  SchoolClasses(this._scaffoldKey);

  @override
  _SchoolClassesState createState() => _SchoolClassesState();
}
...
class _SchoolClassesState extends State<SchoolClasses> {
  ...
  add(String schoolId,departmentId,gradeId,placeId) async{
    print("rr");
    ...
    FirebaseFirestore.instance.collection('classes').add({
      ...
      'placeId': placeId,
      'maxCapacity': int.parse(maxController.text.trim()),
      'minCapacity': int.parse(minController.text.trim()),
      'schoolId': schoolId,
      'gradeId': gradeId,
  ...
  Future<void> _showAddDialog() async {
    String schoolId="",departmentId="",gradeId="",placeId="";
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text("Add Class",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                            ),
                          ),
                          Align(
                      ...
                      InkWell(
                        onTap: (){
                          ...
                          if (_formKey.currentState!.validate()) {
                            add(schoolId,departmentId,gradeId,placeId);
                          }
                        ...
                        child: Container(
                          ...
                          color: Colors.black,
                          alignment: Alignment.center,
                          child: Text("Add Class",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                        ),
                      )
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Classes",widget._scaffoldKey),
