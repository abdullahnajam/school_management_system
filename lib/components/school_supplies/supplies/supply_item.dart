...
import 'package:school_management_system/components/school_supplies/supplies/supply_item_list.dart';
...
class _SupplyItemState extends State<SupplyItem> {
  ...
  add(String categoryId,variationId) async{
    ...
    FirebaseFirestore.instance.collection('supply_items').add({
                                              ...
                                              return Dialog(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: StreamBuilder<QuerySnapshot>(
                                                    stream: FirebaseFirestore.instance.collection('supply_categories').snapshots(),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Supply Item",widget._scaffoldKey),
