...
class SupplyItemList extends StatefulWidget {
  const SupplyItemList({Key? key}) : super(key: key);

  @override
  _SupplyItemListState createState() => _SupplyItemListState();
}


class _SupplyItemListState extends State<SupplyItemList> {
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('supply_items').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => SupplyItemsScreen())));
                  },
                )..show();
              },
