...
class SupplyStockList extends StatefulWidget {
  const SupplyStockList({Key? key}) : super(key: key);

  @override
  _SupplyStockListState createState() => _SupplyStockListState();
}


class _SupplyStockListState extends State<SupplyStockList> {
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('supply_stocks').snapshots(),
                        ...
                        children: [
                                            ...
                                            return Dialog(
                                              ...
                                              child: Container(
                                                ...
                                                child: StreamBuilder<QuerySnapshot>(
                                                  stream: FirebaseFirestore.instance.collection('supply_items').snapshots(),
                                                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                                    if (snapshot.hasError) {
                                                      return Center(
                                                        child: Column(
                                          ...
                                          builder: (context,setState){
                                            return Dialog(
                                              ...
                                              child: Container(
                                                width: MediaQuery.of(context).size.width*0.3,
                                                child: StreamBuilder<QuerySnapshot>(
                                                  stream: FirebaseFirestore.instance.collection('supply_suppliers').snapshots(),
                                                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                                    if (snapshot.hasError) {
                                                      return Center(
                                                        child: Column(
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('supply_stocks').doc(model.id).update({
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('supply_stocks').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => SupplyStockScreen())));
                  },
                )..show();
              },
