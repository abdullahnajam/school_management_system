...
import 'package:school_management_system/components/school_supplies/supply_stock/supply_stock_list.dart';
...
class SupplyStock extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;

  SupplyStock(this._scaffoldKey);

  @override
  _SupplyStockState createState() => _SupplyStockState();
}

class _SupplyStockState extends State<SupplyStock> {
  ...
  add(String _itemId,_supplierId) async{
    ...
    FirebaseFirestore.instance.collection('supply_stocks').add({
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Supply Stock",widget._scaffoldKey),
