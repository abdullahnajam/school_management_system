...
class SupplyVariationList extends StatefulWidget {
  const SupplyVariationList({Key? key}) : super(key: key);

  @override
  _SupplyVariationListState createState() => _SupplyVariationListState();
}


class _SupplyVariationListState extends State<SupplyVariationList> {
...
Future<void> _showEdit(BuildContext context,UniformVariationModel model) async {
    ...
    builder: (BuildContext context) {
      return StatefulBuilder(
        builder: (context, setState) {
          ...
          _valueController.text=model.value.toString();
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('supply_variations').doc(model.id).update({
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = UniformVariationModel.fromSnapshot(data);
  return DataRow(
      cells: [
    DataCell(Text(model.name)),
        DataCell(Text(model.code)),
        DataCell(Text(model.value,maxLines: 1,)),
        DataCell(Row(
          children: [
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('supply_variations').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => SupplyVariationScreen())));
                  },
                )..show();
              },
