...
class SupplySupplierList extends StatefulWidget {
  const SupplySupplierList({Key? key}) : super(key: key);

  @override
  _SupplySupplierListState createState() => _SupplySupplierListState();
}


class _SupplySupplierListState extends State<SupplySupplierList> {
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('supply_suppliers').doc(model.id).update({
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('supply_suppliers').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => SupplySupplierScreen())));
                  },
                )..show();
              },
