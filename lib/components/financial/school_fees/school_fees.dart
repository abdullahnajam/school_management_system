...
class SchoolFees extends StatefulWidget {
  ...
  SchoolFees(this._scaffoldKey);

  @override
  _SchoolFeesState createState() => _SchoolFeesState();
}

class _SchoolFeesState extends State<SchoolFees> {
  ...
  DateTime? date;
  add(String schoolId,departmentId,gradeId) async{
    print("rr");
    final ProgressDialog pr = ProgressDialog(context: context);
    pr.show(max: 100, msg: "Adding");
    FirebaseFirestore.instance.collection('school_fees').add({
      'fees': feesController.text,
      'school': schoolController.text,
      'department': departmentController.text,
      'grade': gradeController.text,
      'month': _monthController.text,
      'date': 0,//date!.millisecondsSinceEpoch,
      'isArchived': false,
      'schoolId': schoolId,
      ...
      await FirebaseFirestore.instance.collection('students').where("gradeId",isEqualTo:gradeId).get().then((QuerySnapshot querySnapshot) {
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text("Add School Fees",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                            ),
                          ),
                          Align(
                      ...
                      InkWell(
                        onTap: (){
                          ...
                          if (_formKey.currentState!.validate()) {
                            add(schoolId,departmentId,_gradeId);
                          }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("School Fees",widget._scaffoldKey),
