...
import 'package:school_management_system/model/financial/school_fee_model.dart';
...
class SchoolFeeList extends StatefulWidget {
  const SchoolFeeList({Key? key}) : super(key: key);

  @override
  _SchoolFeeListState createState() => _SchoolFeeListState();
}


class _SchoolFeeListState extends State<SchoolFeeList> {
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('school_fees').snapshots(),
...
DateTime? date;
Future<void> _showEdit(BuildContext context,SchoolFeeModel model) async {
  ...
  _monthController.text=model.month;
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('school_fees').doc(model.id).update({
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = SchoolFeeModel.fromSnapshot(data);
  return DataRow(
      cells: [
    ...
    DataCell(Text(model.school)),
        ...
        DataCell(Text(model.month.toString())),
        DataCell(Row(
          children: [
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('school_fees').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => SchoolFeesScreen())));
                  },
                )..show();
              },
