...
class _BusFeesState extends State<BusFees> {
  ...
  DateTime? date;
  add(String _busLineId,schoolId,did,gid) async{
    print("rr");
    final ProgressDialog pr = ProgressDialog(context: context);
    pr.show(max: 100, msg: "Adding");
    FirebaseFirestore.instance.collection('bus_fees').add({
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text("Add Bus Fees",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.black),),
                            ),
                          ),
                          Align(
                      ...
                      InkWell(
                        onTap: (){
                          ...
                          if (_formKey.currentState!.validate()) {
                            add(_busLineId,schoolId,departmentId,_gradeId);
                          }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Bus Fees",widget._scaffoldKey),
