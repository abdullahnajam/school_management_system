...
class UniformFeeList extends StatefulWidget {
  const UniformFeeList({Key? key}) : super(key: key);

  @override
  _UniformFeeListState createState() => _UniformFeeListState();
}


class _UniformFeeListState extends State<UniformFeeList> {
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('uniform_fees').snapshots(),
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('No uniform item fee generated'),
                    ],
                  ),
                );
              }
...
Future<void> _showEdit(BuildContext context,UniformFeeModel model) async {
  String _uniformItemId=model.uniformItemId;
  feesController.text=model.fees;
  uniformItemController.text=model.uniformItem;
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('uniform_fees').doc(model.id).update({
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = UniformFeeModel.fromSnapshot(data);
  return DataRow(
      cells: [
        DataCell(Text(model.uniformItem)),
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('uniform_fees').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => UniformFeeScreen())));
                  },
                )..show();
              },
