...
class ActivityFeeList extends StatefulWidget {
  const ActivityFeeList({Key? key}) : super(key: key);

  @override
  _ActivityFeeListState createState() => _ActivityFeeListState();
}


class _ActivityFeeListState extends State<ActivityFeeList> {
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('activity_fees').snapshots(),
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('No activity fee generated'),
                    ],
                  ),
                );
              }
...
Future<void> _showEdit(BuildContext context,ActivityFeeModel model) async {
  String schoolId=model.schoolId;
  String departmentId=model.departmentId;
  String _activityId=model.activityId;
  feesController.text=model.fees;
  schoolController.text=model.school;
  activityController.text=model.activity;
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              FirebaseFirestore.instance.collection('activity_fees').doc(model.id).update({
...
DataRow _buildListItem(BuildContext context, DocumentSnapshot data) {
  final model = ActivityFeeModel.fromSnapshot(data);
  return DataRow(
      cells: [
    DataCell(Text(model.school)),
        DataCell(Text(model.department)),
        DataCell(Text(model.activity)),
            ...
            IconButton(
              ...
              onPressed: (){
                AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    FirebaseFirestore.instance.collection('activity_fees').doc(model.id).delete().then((value) =>
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => ActivityFeeScreen())));
                  },
                )..show();
              },
